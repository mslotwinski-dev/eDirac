...
import B_5 from '@/data/books/content/physics_nuclear/74829125'
import B_6 from '@/data/books/content/physics_nuclear/74829126'
import B_7 from '@/data/books/content/physics_nuclear/74829127'
import B_8 from '@/data/books/content/physics_nuclear/74829128'
...
export const Physics_Nuclear_1: Book = {
  ...
  Part: 1,
  Subtitles: ['Podstawy fizyki atomowej'],
...
export const Physics_Nuclear_2: Book = {
  ...
  Part: 2,
  Subtitles: ['Fizyka cząstek i oddziaływań elementarnych', ''],
  Content: B_2,
}
...
export const Physics_Nuclear_5: Book = {
  ID: '74829124',
...
export const Physics_Nuclear_6: Book = {
  ID: '74829125',
...
export const Physics_Nuclear_7: Book = {
  ID: '74829126',
