<template>
  <Article>
    ...
    <Section>
      ...
      prędkości będzie przeciwny jak podczas omawiania drgań i fal. Ciało, które
      porusza się do z dodatnią prędkością, ale z ujemnym przyspieszeniem
      porusza się co przodu, ale z malejącą prędkością, która jednak w
      granicznej chwili może się za sprawą spowalniania zatrzymać lub zmienić
      znak, co zaobserwujemy jako cofanie.
    </Section>
  </Article>
</template>
