<template>
  <Article>
    <Begin nr="2.3" advanced="0"> Kinematyczne równania ruchu </Begin>
    ...
    <Section>
      ...
      kinematyki są dwa wzory: (2.4) oraz (2.5), jednak przypomnijmy je.
      Pierwszy wzór to definicja przyspieszenia.
    </Section>
    <Math center="true" nr="2.4"> {\displaystyle v=v_0+at} </Math>
    <Section>
    ...
    <Section>
      ...
      równaniach (2.4) oraz (2.5) występują właśnie po trzy wielkości z których
