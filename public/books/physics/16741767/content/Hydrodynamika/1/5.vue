<template>
  <Article>
    <Begin nr="1.6" advanced="0"> Siły działające w płynach</Begin>
    <h3>Siły masowe</h3>
    <Section>
    ...
    <Section>
      ...
      9,81 <M s="\frac{m}{s^2}" />. Jakiś sens to ma, w końcu co innego może
    ...
    <Formula nr="1.16"> {\displaystyle \sigma = \frac{dF}{dS} }. </Formula>
    <Section>
    ...
    <Section>
      ...
      przekształcając wzór (2.1) fdm. Odejmijmy od pozostałych sił masowych f
    ...
    <Section>
      ...
      używać symbolu <M s="\iint" /> i <M s="\iint" />, jednak nie jest to
      obowiązek i w wielu podręcznikach tego nie uświadczysz, a zapis robi się
      wtedy dość nieczytelny. Wolę zachować czystość zapisu niż podlizywać się
      matematykom teoretycznym. Jeśli to czytacie, to nie pozdrawiam was.
    </Section>
  </Article>
</template>
